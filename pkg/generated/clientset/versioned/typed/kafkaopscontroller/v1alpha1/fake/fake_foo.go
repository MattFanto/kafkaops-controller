...
var foosResource = schema.GroupVersionResource{Group: "kafkaopscontroller.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "kafkaopscontroller.k8s.io", Version: "v1alpha1", Kind: "Foo"}
