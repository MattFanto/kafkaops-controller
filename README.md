...
* `pkg/apis/kafkaopscontroller/v1alpha1/zz_generated.deepcopy.go`
* `pkg/generated/`
...
```sh
go get -d github.com/mattfanto/kafkaops-controller
cd $GOPATH/src/github.com/mattfanto/kafkaops-controller
godep restore
```
...
`kubernetes/staging/src/github.com/mattfanto/kafkaops-controller` and its dependencies
...
kubectl create -f artifacts/examples/example-topic.yaml
...
```sh
kubectl delete crd foos.kafkaopscontroller.k8s.io
```
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/mattfanto/kafkaops-controller.
